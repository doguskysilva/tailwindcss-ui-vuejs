          ...
          >
            ...
            <div class="hidden md:block md:ml-10 md:pr-4">
              <a
                ...
                :key="menuOption"
                href="#"
                class="mr-8 font-medium text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out"
                >{{ menuOption }}</a
              >
              <a
                href="#"
              ...
              >
                ...
                <div class="px-2 pt-2 pb-3">
                  <a
                    ...
                    :key="menuOption"
                    href="#"
                    class="mb-1 block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-150 ease-in-out"
                    role="menuitem"
                    >{{ menuOption }}</a
                  >
                </div>
...
export default defineComponent({
  name: "AngledImage",
  data: () => ({
    menuOptions: ["Product", "Features", "Marketplace", "Company"],
    showMenu: false
  })
});
</script>
